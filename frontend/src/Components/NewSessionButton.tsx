			...
			<Tooltip title="Click to Open New Session">
				...
				>
					<Box sx={style}>
						...
						<Typography id="modal-modal-description" sx={{ mt: 1, mb: 3.5,  color: 'text.secondary' }}>
						...
						<div style={{ display: "flex", justifyContent: "flex-end", gap:"1rem"}}>
							...
							<Button onClick={handleClose} sx={{color:"black", padding:"0.5rem", "&:hover": { backgroundColor: "rgba(0,0,0,0.1)"}}}>
								<b>Cancel</b>
							</Button>
						</div>
					</Box>
